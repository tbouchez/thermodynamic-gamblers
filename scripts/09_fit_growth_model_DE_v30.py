...
def main(input_file='07a_growth_data_1054_strains_v30.xlsx',
         output_file='07b_DE_results_1054_strains_v30.xlsx',
         seed=42):
    """
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', '-i', default='07a_growth_data_1054_strains_v30.xlsx',
                       help='Input growth data file')
    parser.add_argument('--output', '-o', default='07b_DE_results_1054_strains_v30.xlsx',
